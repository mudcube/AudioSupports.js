/*
	----------------------------------------------------------
	AudioSupports : 2015-12-21 : https://mudcu.be
	----------------------------------------------------------
...
(function () { 'use strict';
	...
	function canPlayThrough(test) {
		...
		var src = 'data:audio/' + format + ';base64,' + base64;
		var audio = new Audio();
		audio.id = 'audio';
		...
		audio.onerror = function (err) {
			if (testBlobURL && !audio.testedBlobURL) {
	...
	var testBlobURL = !!(typeof URL !== 'undefined' && URL.createObjectURL);
